                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex justify-end items-center gap-1">
                            ...
                            <button
                              type="button"
                              id={`customer-table-delete-btn-${customer.id}`}
                              aria-label={`Delete customer ${customer.name}`}
                              onClick={() => setCustomerToDelete(customer)}
                              className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 active:bg-rose-100 rounded-md transition cursor-pointer"
                              title="Delete Client"
                            >
                  ...
                  >
                    ...
                    <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          type="button"
                          id={`customer-card-delete-btn-${customer.id}`}
                          aria-label={`Delete customer ${customer.name}`}
                          onClick={() => setCustomerToDelete(customer)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="bg-white rounded-xl max-w-sm w-full p-4 sm:p-6 shadow-2xl border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
            ...
            <p className="text-xs text-slate-600 mt-2 leading-relaxed">
              Are you sure you want to delete <span className="font-bold text-slate-900">{customerToDelete.name}</span>
            ...
            <div className="p-2.5 bg-rose-50 border border-rose-100 rounded-lg mt-3 text-[11px] text-rose-700 flex items-center gap-2">
              ...
              <span>This client and their contact details will be removed.</span>
            </div>
            <div className="mt-5 flex items-center justify-end space-x-2">
              <button
                type="button"
                id="cancel-customer-delete-btn"
              ...
              <button
                type="button"
                id="confirm-customer-delete-btn"
                onClick={() => {
